        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginLeft: 'auto' }}>
          ...
          <button
            ...
            style={{
              ...
              border: tickState === 'done' ? 'none' : '0.5px solid var(--warm-border)',
              background: tickState === 'done' ? 'var(--charcoal)' : 'transparent',
        ...
        <div style={{ borderTop: '0.5px solid var(--warm-hairline)', padding: 18, background: '#FAFAF8' }}>
          ...
          {steps.map((text, i) => (
            <div key={i} style={{ display: 'flex', gap: 10, marginBottom: 12 }}>
              ...
              <p style={{ fontSize: 13, fontWeight: 300, color: 'var(--charcoal-mid)', lineHeight: 1.6 }}>{text}</p>
            </div>
          ))}
    ...
    <div className="screen">
      ...
      <div style={{ padding: '0 20px' }}>
        <ExCard
          ...
          steps={[
            'Start easy for the first 5 minutes — your joints need time to warm up, especially in the morning. Don\'t push straight away.',
            'On the hill, lean slightly forward from the ankles — not the waist. Shorter steps, arms moving, breathing steady. This is the same core stability that keeps you upright on a board in a gust.',
            'Aim to be slightly breathless but still able to talk. That\'s the zone that builds the cardiovascular base you need for a full day on the water.',
          ]}
        ...
        <ExCard
          ...
          steps={[
            'Squats: feet shoulder-width apart, toes slightly out. Lower slowly — 3 counts down, 1 up. Keep your chest up. This builds the leg power that drives your gybes and tacks.',
            'Lunges: step forward, lower your back knee toward the floor without touching it. Front knee stays directly above your ankle. This is single-leg stability — exactly what you need when the board is moving under you.',
            'Single leg balance: stand on one foot for 30 seconds, then switch. Hold a wall if you need to. The goal is to need it less every week — this is your most windsurfing-specific exercise.',
          ]}
        ...
        <ExCard
          ...
          steps={[
            'Hip circles: hands on hips, feet shoulder-width. Draw large slow circles — 10 each direction. Your hips are the pivot point of every manoeuvre on the water. Keep them moving.',
            'Shoulder rolls and cross-body stretch: roll both shoulders backward 10 times, then forward 10. Then pull one arm across your chest and hold 20 seconds. Switch. Your shoulders take the load of every gust — look after them.',
            'Ankle rotations: lift one foot, draw slow circles — 10 each direction, then switch. Do this while the kettle boils. Ankle mobility affects your stance and balance on an unstable board more than most people realise.',
            'Cat/cow: on hands and knees, arch your back up toward the ceiling then let it dip toward the floor. 10 slow reps. Breathe with the movement. This keeps your spine supple for the rotation you need when you\'re looking upwind.',
          ]}
      ...
      <div style={{ margin: '18px 20px 0', background: 'var(--white)', borderRadius: 'var(--r-md)', border: '0.5px solid var(--warm-hairline)', padding: 18, boxShadow: 'var(--shadow-card)' }}>
        ...
        <div style={{ background: '#F7F3ED', border: '0.5px solid rgba(44,35,24,0.15)', borderRadius: 10, padding: '12px 14px', fontSize: 14, color: 'var(--warm-light)', fontWeight: 300 }}>
          e.g. Can I swap lunges for something easier on my knees?
        </div>
